 ...
 */
export const get = (fallback = envs.dev) => process.env.NODE_ENV || fallback;
/**
 ...
 */
export const is = (value) => process.env.NODE_ENV === value;
/**
...
export function match(value) {
    var _a, _b;
    const env = (_a = get(null)) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase();
