 ...
 */
export const getInitials = (name, fallback = '?') => typeof name === 'string' && name.length > 0
    ? name
        .replace(/\s+/g, ' ')
        .split(' ')
        .slice(0, 2)
        .map(v => v === null || v === void 0 ? void 0 : v[0].toUpperCase())
        .join('')
    : fallback;
/**
 ...
 */
export const isNullOrEmpty = (x) => x == null || x === '';
