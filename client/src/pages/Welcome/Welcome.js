...
const Welcome = () => {
    return (
        <div className='w-full h-full-screen flex justify-start items-start'>
            <div className='relative  flex flex-col items-center bg-violet-800 w-full h-1/2'>
                <motion.div
                    layout
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className='absolute -bottom-1/2 p-20 rounded flex justify-center flex-col items-center bg-neutral-800'>
